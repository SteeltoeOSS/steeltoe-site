...
You will need https://git-scm.com[Git] in order to obtain the code for the Config Server that we'll be using. If you haven't already installed Git, follow the https://git-scm.com/book/en/v2/Getting-Started-Installing-Git[instructions] to do so.
...
```
spring-cloud-config-server>.\mvnw spring-boot:run
